...
export default class Watermark extends Module {
	...
	onEnable() {
		if (!this.watermarkElement) {
			...
			watermarkElement.style.textShadow =
				"var(--Ballcrack-accent-color) 0px 0px 10px";
			watermarkElement.style.background = "var(--Ballcrack-accent-color)";
			watermarkElement.style.backgroundClip = "text";

			this.mainText = document.createElement("span");
			this.mainText.textContent = "Ballcrack";

			const versionText = document.createElement("span");
			versionText.textContent = "v1";
