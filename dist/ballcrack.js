...
.gui-button-container {\r
    user-select: none;\r
}`;function _(i){let e=document.createElement("style");e.textContent=i,d.wrapper.appendChild(e)}var K=new FontFace("Product Sans","url(https://fonts.gstatic.com/s/productsans/v19/pxiDypQkot1TnFhsFMOfGShVF9eO.woff2)",{style:"normal",weight:"400"});K.load().then(i=>document.fonts.add(i));var q=new FontFace("Inter","url(https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMa.woff2)",{style:"normal",weight:"300"});q.load().then(i=>document.fonts.add(i));_(U);I.init();a.hookOnTick();document.addEventListener("keydown",i=>{c.emit("keydown",i.code)});setInterval(()=>{c.emit("render")},1e3/60);var X=!0;X&&(window.ballcrack={hooks:a,shadowWrapper:d,moduleManager:I,interactionUtils:O,blockUtils:H});})();
