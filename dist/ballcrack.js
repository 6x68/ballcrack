...
`;function Q(i){let e=document.createElement("style");e.textContent=i,d.wrapper.appendChild(e)}var Z=new FontFace("Product Sans","url(https://fonts.gstatic.com/s/productsans/v19/pxiDypQkot1TnFhsFMOfGShVF9eO.woff2)",{style:"normal",weight:"400"});Z.load().then(i=>document.fonts.add(i));var ee=new FontFace("Inter","url(https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMa.woff2)",{style:"normal",weight:"300"});ee.load().then(i=>document.fonts.add(i));Q(_);H.init();a.hookOnTick();document.addEventListener("keydown",i=>{p.emit("keydown",i.code)});setInterval(()=>{p.emit("render")},1e3/60);var te=!0;te&&(window.ballcrack={hooks:a,shadowWrapper:d,moduleManager:H,interactionUtils:W,blockUtils:f});})();
