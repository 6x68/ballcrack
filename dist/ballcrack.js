(()=>{var a={get game(){return this._game?this._game:this._game=Object.values(document.querySelector("#react"))[0].updateQueue.baseState.element.props.game}};var u={listeners:{},activeKeys:new Set,on:function(i,e){this.listeners[i]||(this.listeners[i]=[]),this.listeners[i].push(e)},remove:function(i,e){this.listeners[i]&&(this.listeners[i]=this.listeners[i].filter(t=>t!==e))},emit:function(i,e){this.listeners[i]&&this.listeners[i].forEach(t=>t(e))},trackKey:function(i,e,t){i==="keydown"&&moduleManager.handleKeyPress(t),i==="keydown"&&!this.activeKeys.has(e)&&(this.activeKeys.add(e),this.emit("keyPress",{key:e,code:t})),i==="keyup"&&this.activeKeys.has(e)&&(this.activeKeys.delete(e),this.emit("keyRelease",{key:e,code:t}))}};var H={normalizeVector(i){let e=i.x*i.x+i.y*i.y+i.z*i.z;if(e>0){let t=1/Math.sqrt(e);return[i.x*t,i.y*t,i.z*t]}return i},distanceBetween(i,e){let t=e.x-i.x,o=e.y-i.y,r=e.z-i.z;return t*t+o*o+r*r},distanceBetweenSqrt(i,e){return Math.sqrt(this.distanceBetween(i,e))}};var c=class{constructor(e,t,o,r){this.name=e,this.category=t,this.options=o,this.keybind=r,this.waitingForBind=!1,this.isEnabled=!1,this.modes={},this.toggle=this.toggle.bind(this)}registerMode(e,t){this.modes[e]=t}onEnable(){}onDisable(){}onRender(){}onSettingUpdate(){}onChunkAdded(){}onChunkRemoved(){}onGameEntered(){}onGameExited(){}onNoaTick(){}enable(){this.isEnabled=!0,u.emit("module.update",this),u.emit("module.toggle",{name:this.name,enabled:!0}),this.onEnable()}disable(){this.isEnabled=!1,u.emit("module.update",this),u.emit("module.toggle",{name:this.name,enabled:!1}),this.onDisable()}toggle(){this.isEnabled?this.disable():this.enable()}};var w=class extends c{constructor(){super("Killaura","Combat",{"Y Offset":1.62,Reach:10,Delay:100}),this.lastExecutionTime=null}onRender(){let e=Date.now();e-this.lastExecutionTime>=this.options.Delay&&(this.lastExecutionTime=e,this.tryKill())}tryKill(){a.game.world.loadedEntityList.forEach(e=>{let t=H.distanceBetween(e.pos,a.game.player.pos);a.game.player.id!==e.id&&t<14&&(a.game.controller.objectMouseOver.hitVec=e.pos.clone(),a.game.controller.attackEntity(e))})}};var v=class extends c{constructor(){super("SelfHarm","Misc")}onEnable(){a.game.controller.objectMouseOver.hitVec=a.game.player.pos.clone(),a.game.controller.attackEntity(a.game.player),this.disable()}};var k=class extends c{constructor(){super("Airjump","Movement",null)}onEnable(){a.game.player.__defineGetter__("onGround",()=>!0),a.game.player.__defineSetter__("onGround",()=>!0)}onDisable(){delete a.game.player.onGround,a.game.player.onGround=!1}};var C=class extends c{constructor(){super("HighJump","Movement",{"Jump Velocity":.6})}onEnable(){a.game.player.initialJumpVelocity=parseFloat(this.options["Jump Velocity"])}onDisable(){a.game.player.initialJumpVelocity=.42}};var E=class extends c{constructor(){super("Phase","Movement",null)}onEnable(){a.game.player.height=0}onDisable(){a.game.player.height=1.8}};var L=class extends c{constructor(){super("Speed","Movement",{"Air Speed":.03})}onEnable(){a.game.player.speedInAir=parseFloat(this.options["Air Speed"])}onDisable(){a.game.player.speedInAir=.02}};var B=class extends c{constructor(){super("Step","Movement",{Height:2})}onEnable(){a.game.player.stepHeight=parseFloat(this.options.Height)}onDisable(){a.game.player.stepHeight=.6}};var f={parseRGBString(i){let e=i.replaceAll("rgb","").replaceAll("a","").replaceAll("(","").replaceAll(")","").replaceAll(" ","").split(",");return{r:parseFloat(e?.[0]||1),g:parseFloat(e?.[1]||1),b:parseFloat(e?.[2]||1),a:parseFloat(e?.[3]||1)}},normalizeColor(i){return i?i.r<=1&&i.g<=1&&i.b<=1?i:{r:i.r/255,g:i.g/255,b:i.b/255}:{r:1,g:1,b:1}},hexToRGBA(i,e=1,t=1){let o=i.startsWith("#")?i.substring(1):i;o.length===3&&(o=o.split("").map(d=>d+d).join(""));let r=parseInt(o.substring(0,2),16)*t,n=parseInt(o.substring(2,4),16)*t,s=parseInt(o.substring(4,6),16)*t;return`rgba(${Math.round(r)}, ${Math.round(n)}, ${Math.round(s)}, ${e})`},hexToRgb(i){var e=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(i);return e?{r:parseInt(e[1],16),g:parseInt(e[2],16),b:parseInt(e[3],16)}:null}};var l={instance:null,get wrapper(){if(!this.instance){let i=document.createElement("iframe");document.body.appendChild(i);let e=i.contentWindow.Element.prototype.attachShadow;i.remove();let t=document.createElement("div");this.root=e.apply(t,[{mode:"closed"}]);let o=document.createElement("div");this.root.appendChild(o),this.instance=o,document.body.appendChild(t)}return this.instance}};var D=class extends c{constructor(){super("Arraylist","Visual",{Opacity:1,"Background Opacity":.1,"Darkness Multiplier":.3,"Accent Darkness":.5,Blur:1}),this.namesMap={},this.arraylistContainer=null,this.initialized=!1}getAccentColors(){let e=getComputedStyle(l.wrapper);return["--Ballcrack-accent-color-1","--Ballcrack-accent-color-2"].map(t=>e.getPropertyValue(t).trim())}update(e,t){if(t){if(!this.namesMap[e]){let r=document.createElement("div"),n=this.getAccentColors(),s=parseFloat(this.options["Background Opacity"]),d=parseFloat(this.options["Darkness Multiplier"]),h=parseFloat(this.options["Accent Darkness"]),m=parseFloat(this.options.Blur);r.style.background=`linear-gradient(to right, ${f.hexToRGBA(n[0],s,h)}, ${f.hexToRGBA(n[1],s+.2,h+.2)})`,r.style.backdropFilter=`blur(${m}px) brightness(${d})`,r.style.color="white",r.style.padding="2px 10px",r.style.display="flex",r.style.alignItems="center",r.style.boxSizing="border-box",r.style.margin="0",r.style.lineHeight="1",r.style.gap="0",r.style.fontFamily="'Product Sans', sans-serif",r.style.boxShadow="rgb(0, 0, 0, 0.05) -5px 1px",r.style.transition="opacity 0.2s ease-in-out, max-height 0.2s ease-in-out",r.style.overflow="hidden",r.style.maxHeight="0",r.style.opacity=parseFloat(this.options.Opacity);let g=document.createElement("span");g.style.fontWeight="800",g.style.fontSize="16px",g.style.backgroundImage="var(--Ballcrack-accent-color)",g.style.color="transparent",g.style.backgroundClip="text",g.style.webkitBackgroundClip="text",g.innerHTML=e,r.appendChild(g),this.arraylistContainer.appendChild(r),setTimeout(()=>{r.style.maxHeight="50px",r.style.opacity="1"},1),this.namesMap[e]=r}}else if(this.namesMap[e]){let r=this.namesMap[e];r.style.maxHeight="0",r.style.opacity="0",setTimeout(()=>{this.arraylistContainer.contains(r)&&this.arraylistContainer.removeChild(r),delete this.namesMap[e]},200)}let o=Object.values(this.namesMap).sort((r,n)=>this.measureElementWidth(n)-this.measureElementWidth(r));this.arraylistContainer.innerHTML="",o.forEach(r=>this.arraylistContainer.appendChild(r))}onEnable(){this.initialized?this.arraylistContainer.style.opacity="1":(this.arraylistContainer=document.createElement("div"),this.arraylistContainer.style.flexDirection="column",this.arraylistContainer.style.display="flex",this.arraylistContainer.style.gap="0",this.arraylistContainer.style.lineHeight="0",this.arraylistContainer.style.position="absolute",this.arraylistContainer.style.zIndex="99999",this.arraylistContainer.style.right="5px",this.arraylistContainer.style.top="5px",this.arraylistContainer.style.alignItems="flex-end",this.arraylistContainer.style.pointerEvents="none",this.arraylistContainer.style.textTransform="lowercase",this.arraylistContainer.style.border="2px solid transparent",this.arraylistContainer.style.borderImage="var(--Ballcrack-accent-color)",this.arraylistContainer.style.borderImageSlice="1",this.arraylistContainer.style.borderBottom="0",this.arraylistContainer.style.borderLeft="0",l.wrapper.appendChild(this.arraylistContainer),u.on("module.update",e=>{this.update(e.name,e.isEnabled)}),this.initialized=!0)}onSettingUpdate(e){if(e=="ClickGUI"||e=="Arraylist"){let t=this.getAccentColors(),o=parseFloat(this.options["Background Opacity"]),r=parseFloat(this.options["Darkness Multiplier"]),n=parseFloat(this.options["Accent Darkness"]),s=parseFloat(this.options.Blur);Object.values(this.namesMap).forEach(d=>{d.style.background=`linear-gradient(to right, ${f.hexToRGBA(t[0],o,n)}, ${f.hexToRGBA(t[1],o+.2,n+.2)})`,d.style.backdropFilter=`blur(${s}px) brightness(${r})`,d.style.opacity=parseFloat(this.options.Opacity)})}}measureElementWidth(e){return e.getBoundingClientRect().width}onDisable(){this.arraylistContainer.style.opacity="0"}};var M=class extends c{constructor(){super("Chams","Visual","")}onEnable(){let e=a.game.player.mesh.constructor.prototype;this._renderPlayers=this.__renderPlayers||e.render;let t=this;e.render=function(){for(let o in this.meshes)this.meshes[o].material.depthTest=!1,this.meshes[o].renderOrder=3;for(let o in this.armorMesh)this.armorMesh[o].material.depthTest=!1,this.armorMesh[o].renderOrder=4;if(this.capeMesh&&(this.capeMesh.children[0].material.depthTest=!1,this.capeMesh.children[0].renderOrder=5),this.hatMesh)for(let o of this.hatMesh.children[0].children)o.material&&(o.material.depthTest=!1,o.renderOrder=4);return t._renderPlayers.apply(this,arguments)}}onDisable(){let e=a.game.player.mesh.constructor.prototype;e.render=this._renderPlayers}};var z=class{constructor(e,t){this.module=e,this.container=t,this.components=[],this.initialized=!1,this.isOpen=!1,this.activeDropdown=null,this.currentOptionsList=null,this.activeDropdownListeners=null}initialize(){if(this.initialized||!this.module?.options)return;this.settingsWrapper=document.createElement("div"),this.settingsWrapper.className="module-settings-wrapper",this.container.appendChild(this.settingsWrapper),this.settingsContainer=document.createElement("div"),this.settingsContainer.className="module-settings scrollable",this.settingsWrapper.appendChild(this.settingsContainer),this.container.style.position="relative";let e=Object.keys(this.module.options),t=this.groupSettings(e);this.createSettings(t),this.initialized=!0}groupSettings(e){return e.reduce((t,o)=>{let r=this.module.options[o],n=typeof r;return o.toLowerCase().includes("color")?t.color.push(o):this.module.modes&&this.module.modes[o]?t.mode.push(o):n==="boolean"||r==="true"||r==="false"?t.boolean.push(o):t.other.push(o),t},{boolean:[],mode:[],other:[],color:[]})}createSettings(e){[...e.boolean,...e.mode,...e.other,...e.color].forEach(t=>{let o=this.module.options[t],r=typeof o;t.toLowerCase().includes("color")?this.addColorPicker(t):this.module.modes&&this.module.modes[t]?this.addModeSelector(t):r==="boolean"||o==="true"||o==="false"?this.addCheckbox(t):r==="string"?this.addStringInput(t):this.addNumberInput(t)})}toggle(){this.isOpen=!this.isOpen,this.isOpen&&this.settingsWrapper?.classList?(this.settingsWrapper.classList.add("module-settings-open"),this.checkPositionWithinViewport()):this.settingsWrapper?.classList&&(this.settingsWrapper.classList.remove("module-settings-open"),this.closeAllDropdowns())}checkPositionWithinViewport(){if(!this.settingsWrapper)return;let e=this.settingsWrapper.getBoundingClientRect(),t=window.innerHeight;if(e.bottom>t){let o=e.bottom-t;this.settingsWrapper.style.maxHeight=`${e.height-o-10}px`}}cleanup(){this.closeAllDropdowns(),this.isOpen=!1,this.settingsWrapper&&this.settingsWrapper.classList.remove("module-settings-open")}closeAllDropdowns(){document.querySelectorAll(".gui-dropdown-options").forEach(t=>{l.wrapper.contains(t)&&l.wrapper.removeChild(t)}),this.currentOptionsList&&(this.currentOptionsList=null),this.activeDropdown&&(this.activeDropdown.classList.remove("open"),this.activeDropdown.optionsListElement&&(this.activeDropdown.optionsListElement=null),this.activeDropdown=null),this.activeDropdownListeners&&(document.removeEventListener("click",this.activeDropdownListeners.outsideClickHandler),window.removeEventListener("scroll",this.activeDropdownListeners.hideDropdown,!0),window.removeEventListener("resize",this.activeDropdownListeners.hideDropdown,!0),this.activeDropdownListeners=null)}addNumberInput(e){let t=document.createElement("div");t.className="gui-setting-container setting-number";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let r=document.createElement("div");r.className="number-input-container";let n=document.createElement("input");n.type="text",n.className="gui-text-input number-input",n.value=this.module.options[e],n.addEventListener("input",()=>{let s=n.value.trim();!isNaN(s)&&s!==""&&(this.module.options[e]=s,u.emit("setting.update",{moduleName:this.module.name,setting:e,value:s}))}),n.addEventListener("blur",()=>{(isNaN(n.value)||n.value.trim()==="")&&(n.value=this.module.options[e])}),n.addEventListener("keydown",s=>{s.key==="Enter"&&n.blur()}),r.appendChild(n),t.appendChild(o),t.appendChild(r),this.settingsContainer.appendChild(t),this.components.push(t)}addStringInput(e){let t=document.createElement("div");t.className="gui-setting-container setting-string";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let r=document.createElement("div");r.className="string-input-container";let n=document.createElement("input");n.type="text",n.className="gui-text-input string-input",n.value=this.module.options[e],n.addEventListener("input",()=>{this.module.options[e]=n.value,u.emit("setting.update",{moduleName:this.module.name,setting:e,value:n.value})}),n.addEventListener("keydown",s=>{s.key==="Enter"&&n.blur()}),r.appendChild(n),t.appendChild(o),t.appendChild(r),this.settingsContainer.appendChild(t),this.components.push(t)}addCheckbox(e){let t=document.createElement("div");t.className="gui-setting-container setting-boolean";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let r=document.createElement("div");r.className="checkbox-container";let n=document.createElement("div");n.className="gui-checkbox",(this.module.options[e]===!0||this.module.options[e]==="true")&&n.classList.add("enabled"),t.addEventListener("click",()=>{let s=!(this.module.options[e]===!0||this.module.options[e]==="true");this.module.options[e]=s.toString(),s?n.classList.add("enabled"):n.classList.remove("enabled"),u.emit("setting.update",{moduleName:this.module.name,setting:e,value:s.toString()})}),r.appendChild(n),t.appendChild(o),t.appendChild(r),this.settingsContainer.appendChild(t),this.components.push(t)}addColorPicker(e){let t=document.createElement("div");t.className="gui-setting-container setting-color";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let r=document.createElement("div");r.className="gui-color-row";let n=document.createElement("div");n.className="color-picker-container";let s=document.createElement("div");s.className="gui-color-picker",s.style.background=this.module.options[e];let d=document.createElement("input");d.type="color",d.className="gui-color-input",d.value=this.rgbToHex(this.module.options[e]);let h=document.createElement("input");h.type="text",h.className="gui-text-input color-text-input",h.value=this.formatColor(this.module.options[e]),d.addEventListener("input",m=>{let g=m.target.value;s.style.background=g,h.value=g,this.module.options[e]=g,u.emit("setting.update",{moduleName:this.module.name,setting:e,value:g})}),h.addEventListener("blur",()=>{try{let m=h.value;s.style.background=m,this.module.options[e]=m,u.emit("setting.update",{moduleName:this.module.name,setting:e,value:m})}catch{h.value=this.formatColor(this.module.options[e])}}),h.addEventListener("keydown",m=>{m.key==="Enter"&&h.blur()}),s.appendChild(d),n.appendChild(s),r.appendChild(n),r.appendChild(h),t.appendChild(o),t.appendChild(r),this.settingsContainer.appendChild(t),this.components.push(t)}addModeSelector(e){let t=document.createElement("div");t.className="gui-setting-container setting-mode";let o=document.createElement("div");o.className="gui-setting-label",o.textContent=e;let r=this.module.modes?.[e]||[],n=this.module.options[e],s=document.createElement("div");s.className="gui-dropdown mode-dropdown";let d=document.createElement("div");d.className="gui-dropdown-selected",d.textContent=n;let h=document.createElement("div");h.className="gui-dropdown-arrow",s.appendChild(d),s.appendChild(h);let m=()=>{if(!s.classList.contains("open"))return;let p=s.optionsListElement;p&&l.wrapper.contains(p)&&l.wrapper.removeChild(p),this.currentOptionsList===p&&(this.currentOptionsList=null),this.activeDropdown===s&&(this.activeDropdown=null),s.classList.remove("open"),s.optionsListElement=null,this.activeDropdownListeners&&this.activeDropdownListeners.dropdown===s&&(document.removeEventListener("click",this.activeDropdownListeners.outsideClickHandler),window.removeEventListener("scroll",this.activeDropdownListeners.hideDropdown,!0),window.removeEventListener("resize",this.activeDropdownListeners.hideDropdown,!0),this.activeDropdownListeners=null)},g=p=>{let b=s.optionsListElement;!s.contains(p.target)&&(!b||!b.contains(p.target))&&m()},T=()=>{m()},O=()=>{this.closeAllDropdowns();let p=document.createElement("div");p.className="gui-dropdown-options mode-options",r.forEach(x=>{let y=document.createElement("div");y.className="gui-dropdown-option mode-option",x===this.module.options[e]&&y.classList.add("selected"),y.textContent=x,y.addEventListener("click",W=>{W.stopPropagation(),d.textContent=x,this.module.options[e]=x,u.emit("setting.update",{moduleName:this.module.name,setting:e,value:x}),m()}),p.appendChild(y)}),l.wrapper.appendChild(p),s.optionsListElement=p;let b=s.getBoundingClientRect();p.style.width=b.width+"px",p.style.position="fixed";let R=window.innerHeight-b.bottom,F=Math.min(r.length*30,150);R<F&&b.top>F?(p.style.bottom=window.innerHeight-b.top+"px",p.style.top="auto",p.classList.add("dropdown-up")):(p.style.top=b.bottom+"px",p.style.bottom="auto",p.classList.remove("dropdown-up")),p.style.left=b.left+"px",p.style.zIndex="1001",s.classList.add("open"),this.activeDropdown=s,this.currentOptionsList=p,this.activeDropdownListeners={dropdown:s,outsideClickHandler:g,hideDropdown:T},setTimeout(()=>{this.activeDropdown===s&&this.activeDropdownListeners&&this.activeDropdownListeners.dropdown===s&&(document.addEventListener("click",g),window.addEventListener("scroll",T,!0),window.addEventListener("resize",T,!0))},0)};s.addEventListener("click",p=>{p.stopPropagation(),s.classList.contains("open")?m():O()}),t.appendChild(o),t.appendChild(s),this.settingsContainer.appendChild(t),this.components.push(t)}positionDropdown(e,t){let o=e.getBoundingClientRect(),r=this.settingsWrapper.getBoundingClientRect();t.style.position="absolute",t.style.width=o.width+"px",t.style.left="0";let n=window.innerHeight-o.bottom,s=t.clientHeight||150;if(n<s&&o.top>s?(t.style.bottom=o.height+"px",t.style.top="auto",t.classList.add("dropdown-up")):(t.style.top=o.height+"px",t.style.bottom="auto",t.classList.remove("dropdown-up")),t.getBoundingClientRect().right>r.right){let d=t.getBoundingClientRect().right-r.right;t.style.left=-d+"px"}}rgbToHex(e){if(!e)return"#000000";if(e.startsWith("#"))return e;let t=e.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*[\d.]+)?\)/i);if(!t)return"#000000";let o=parseInt(t[1]),r=parseInt(t[2]),n=parseInt(t[3]);return"#"+((1<<24)+(o<<16)+(r<<8)+n).toString(16).slice(1)}formatColor(e){return e?e.startsWith("rgb")?this.rgbToHex(e):e:"#000000"}};var S=class{constructor(e,t={top:"200px",left:"200px"}){this.panel=document.createElement("div"),this.panel.className="gui-panel",this.panel.style.top=t.top,this.panel.style.left=t.left,this.header=document.createElement("div"),this.header.className="gui-header",this.header.textContent=e,this.panel.appendChild(this.header),l.wrapper.appendChild(this.panel),this.buttons=[],this.setupDragHandling()}setupDragHandling(){let e=!1,t={x:0,y:0};this.header.addEventListener("mousedown",o=>{e=!0,t.x=o.clientX-this.panel.offsetLeft,t.y=o.clientY-this.panel.offsetTop}),document.addEventListener("mousemove",o=>{e&&(this.panel.style.left=o.clientX-t.x+"px",this.panel.style.top=o.clientY-t.y+"px")}),document.addEventListener("mouseup",()=>e=!1)}addButton(e){let t=document.createElement("div");t.className="gui-button-container";let o=document.createElement("div");o.className=`gui-button ${e.isEnabled?"enabled":""}`,o.textContent=e.name;let r=new z(e,t);return o.addEventListener("mousedown",n=>{n.button===0&&(e.toggle(),o.classList.toggle("enabled",e.isEnabled)),n.button===1&&(o.textContent="waiting for bind..",e.waitingForBind=!0)}),o.addEventListener("contextmenu",n=>{n.preventDefault(),r.initialize(),r.toggle()}),o.setAttribute("tabindex",-1),o.addEventListener("keydown",n=>{o.textContent=e.name,e.waitingForBind&&(n.preventDefault(),n.stopPropagation(),n.stopImmediatePropagation(),n.key==="Escape"?e.keybind=null:e.keybind=String(n.code),e.waitingForBind=!1)}),t.appendChild(o),this.panel.appendChild(t),this.buttons.push(o),o}show(){this.panel.style.display="block"}hide(){this.panel.style.display="none"}};var A=class extends c{constructor(){super("ClickGUI","Visual",{"Accent Color 1":"#40beffff","Accent Color 2":"#81e1ffff","Button Color":"rgb(40, 40, 40, 0.9)","Hover Color":"rgb(50, 50, 50, 0.9)","Header Color":"rgb(0, 0, 0, 0.85)","Panel Color":"rgb(18 18 18)","Text Color":"#ffffff","Glow Alpha":"0.8","Enable Animations":!0},"ShiftRight"),this.GUILoaded=!1,this.panels=[],this.blurredBackground=null,this.updateColors()}updateAnimations(){this.options["Enable Animations"]?l.wrapper.classList.add("with-animations"):l.wrapper.classList.remove("with-animations")}updateColors(){let e=`linear-gradient(90deg, ${this.options["Accent Color 1"]} 0%, ${this.options["Accent Color 2"]} 100%)`;l.wrapper.style.setProperty("--Ballcrack-accent-color",e),l.wrapper.style.setProperty("--Ballcrack-accent-color",e),l.wrapper.style.setProperty("--Ballcrack-accent-color-1",this.options["Accent Color 1"]),l.wrapper.style.setProperty("--Ballcrack-accent-color-2",this.options["Accent Color 2"]),l.wrapper.style.setProperty("--Ballcrack-button-color",this.options["Button Color"]),l.wrapper.style.setProperty("--button-color",this.options["Button Color"]),l.wrapper.style.setProperty("--hover-color",this.options["Hover Color"]),l.wrapper.style.setProperty("--header-bg",this.options["Header Color"]),l.wrapper.style.setProperty("--panel-bg",this.options["Panel Color"]),l.wrapper.style.setProperty("--text-color",this.options["Text Color"]),l.wrapper.style.setProperty("--glow-color",f.hexToRGBA(this.options["Accent Color 1"],parseFloat(this.options["Glow Alpha"]),1.2))}onEnable(){document.pointerLockElement&&document.exitPointerLock(),this.GUILoaded?(this.showGUI(),this.updateAnimations()):(this.setupBackground(),this.createPanels(),this.setupEventListeners(),this.GUILoaded=!0,this.updateAnimations())}setupBackground(){this.blurredBackground=document.createElement("div"),this.blurredBackground.className="gui-background",l.wrapper.appendChild(this.blurredBackground)}createPanels(){let e=[{title:"Combat",position:{top:"100px",left:"100px"}},{title:"Movement",position:{top:"100px",left:"338px"}},{title:"Visual",position:{top:"100px",left:"576px"}},{title:"World",position:{top:"100px",left:"814px"}},{title:"Misc",position:{top:"100px",left:"1052px"}}];this.panels.forEach(o=>{o.panel&&o.panel.parentNode&&o.panel.parentNode.removeChild(o.panel)}),this.panels=[],e.forEach(o=>{let r=new S(o.title,o.position);this.panels.push(r)});let t={};Object.values(N.modules).forEach(o=>{t[o.category]||(t[o.category]=[]),t[o.category].push(o)}),Object.entries(t).forEach(([o,r])=>{let n=this.panels.find(d=>d.header.textContent===o);if(!n)return;let s=document.createElement("span");s.style.visibility="hidden",s.style.position="absolute",s.style.font="'Product Sans', sans-serif",l.wrapper.appendChild(s),r.sort((d,h)=>{s.textContent=d.name;let m=s.getBoundingClientRect().width;return s.textContent=h.name,s.getBoundingClientRect().width-m}),s.remove(),r.forEach(d=>n.addButton(d))})}setupEventListeners(){u.on("module.update",e=>{let t=this.panels.find(r=>r.header.textContent===e.category);if(!t)return;let o=t.buttons.find(r=>r.textContent===e.name);o&&o.classList.toggle("enabled",e.isEnabled)})}showGUI(){this.panels.forEach(e=>e.show()),this.blurredBackground.style.display="block"}returnToGame(){}onDisable(){this.panels.forEach(e=>e.hide()),this.blurredBackground.style.display="none",this.returnToGame()}onSettingUpdate(){this.updateColors(),this.updateAnimations()}};var P=class extends c{constructor(){super("Watermark","Visual",{Text:"Ballcrack"},""),this.watermarkElement=null,this.mainText=null}onSettingUpdate(){this.mainText&&(this.mainText.textContent=this.options.Text)}onEnable(){if(!this.watermarkElement){let e=document.createElement("div");e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.padding="0.5em",e.style.userSelect="none",e.style.display="flex",e.style.zIndex="999999",e.style.fontFamily="'Product Sans', sans-serif",e.style.fontSize="24px",e.style.backgroundClip="text",e.style.webkitFontSmoothing="antialiased",e.style.webkitTextFillColor="transparent",e.style.textShadow="var(--Ballcrack-accent-color) 0px 0px 10px",e.style.background="var(--Ballcrack-accent-color)",e.style.backgroundClip="text",this.mainText=document.createElement("span"),this.mainText.textContent="Ballcrack";let t=document.createElement("span");t.textContent="v1",t.style.fontSize="14px",t.style.paddingBottom="15px",t.style.marginLeft="4px",t.style.alignSelf="flex-end",e.appendChild(this.mainText),e.appendChild(t),l.wrapper.appendChild(e),this.watermarkElement=e}this.watermarkElement.style.display="flex"}onDisable(){this.watermarkElement.style.display="none"}};var N={modules:{},addModules:function(...i){for(let e of i){let t=new e;this.modules[t.name]=t}},addModule:function(i){this.modules[i.name]=i},handleKeyPress:function(i){for(let e in this.modules){let t=this.modules[e];t.waitingForBind?(t.keybind=i,t.waitingForBind=!1):i&&t.keybind==i&&t.toggle()}},init(){this.addModules(P,A,D,M,k,E,B,C,L,w,v),u.on("render",()=>{for(let i in this.modules)this.modules[i].isEnabled&&this.modules[i].onRender()}),u.on("keydown",this.handleKeyPress.bind(this)),u.on("setting.update",i=>{for(let e in this.modules)(this.modules[e].isEnabled||i.moduleName===e)&&this.modules[e].onSettingUpdate(i.moduleName,i.setting,i.value)}),this.modules.Arraylist.enable(),this.modules.Watermark.enable()}};var I=`:host {\r
...
.gui-button-container {\r
    user-select: none;\r
}`;function Y(i){let e=document.createElement("style");e.textContent=i,l.wrapper.appendChild(e)}var U=new FontFace("Product Sans","url(https://fonts.gstatic.com/s/productsans/v19/pxiDypQkot1TnFhsFMOfGShVF9eO.woff2)",{style:"normal",weight:"400"});U.load().then(i=>document.fonts.add(i));var _=new FontFace("Inter","url(https://fonts.gstatic.com/s/inter/v18/UcCO3FwrK3iLTeHuS_fvQtMwCp50KnMa.woff2)",{style:"normal",weight:"300"});_.load().then(i=>document.fonts.add(i));Y(I);N.init();document.addEventListener("keydown",i=>{u.emit("keydown",i.code)});setInterval(()=>{u.emit("render")},1e3/60);var $=!0;$&&(window.ballcrack={hooks:a,shadowWrapper:l,moduleManager:N});})();
